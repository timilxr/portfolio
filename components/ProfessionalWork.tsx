...
const ProfessionalWork = () => (
  <section id="professional-work" className="mb-16 md:mb-24 lg:mb-36">
    <div className="mb-8">
      <h2 className="text-2xl font-bold text-slate-200 mb-2">Professional Web Applications</h2>
      <p className="text-slate-400 text-base">
        Selected professional and Web3 projects delivered for clients and employers.
      </p>
    </div>
      ...
      {professionalProjects.map((proj, idx) => (
        <li key={idx} className="bg-slate-800/60 rounded-lg p-6 border border-slate-700">
          <h3 className="text-lg font-semibold text-teal-300">
            {proj.company} <span className="text-slate-400 font-normal">– {proj.title} ({proj.dates})</span>
          </h3>
