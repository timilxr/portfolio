            ...
            <li className="mb-12" key={project?.name}>
                <a href={project?.url} target="_blank" rel="noreferrer" aria-label={project?.name} className="group grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50 hover:text-slate-200">
                    ...
                    <div className="sm:order-1 sm:col-span-2">
                        ...
                        <img alt="" loading="lazy" decoding="async" data-img="1" className="rounded border-2 border-slate-200/10 group-hover:border-slate-200/30 responsive object-cover object-center  group-hover:opacity-90" width={200} height={88}
        ...
        <section id="projects" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="Selected projects">
            ...
            <div className="mb-8">
                ...
                <p className="text-slate-400 text-base">
                    Selected personal and professional projects delivered for clients and
                    employers.
                </p>
            </div>
            <div>
